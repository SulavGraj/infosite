        ...
        <div className='container'>
            ...
            <div className='gallery1-slider'>
                <div className='gallery1-items'>
                    ...
                    <p className='gallery1-title'>Group work</p>
                </div>
                <div className='gallery1-items'>
                    <img src={gallery1img2} alt='gallery1img2'/>
                    <p className='gallery1-title'>Coding</p>
                </div>
                <div className='gallery1-items'>
                    <img src={gallery1img3} alt='gallery1img3'/>
                    <p className='gallery1-title'>Planning</p>
                </div>
                <div className='gallery1-items'>
                    <img src={gallery1img4} alt='gallery1img4'/>
                    <p className='gallery1-title'>Testing</p>
                </div>
                <div className='gallery1-items'>
                    <img src={gallery1img5} alt='gallery1img5'/>
                    <p className='gallery1-title'>Office setup</p>
                </div>
            </div>
        </div>
    </section>
